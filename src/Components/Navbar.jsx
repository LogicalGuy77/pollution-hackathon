...
function Navbar() {
  ...
  const demoNavigate = () => {
    window.open(
      import.meta.env.VITE_API_HUGGING_FACE_URL,
      "_blank",
      "noopener,noreferrer"
    );
  };
  return (
    <div className="p-8 grid gap-4 grid-cols-3 bg-gray-600/[0.7] text-cyan-100 text-xl fixed top-0 left-0 right-0 z-10">
